 ...
 <body class="">
        ...
        <div class="my-3 my-md-5">
          <div class="container">
			...
			<div class="alert alert-primary" role="alert">
			  Program that you have been uploaded.
			</div>

			  <?php
    
			  
			  $sql="SELECT program.KodProgram, kelab.NamaKelab, program.NamaProgram, program.BilanganTerhad, program.TarikhProgram, program.ButiranProgram FROM program, kelab, pelajar WHERE kelab.IdKelab = program.KodKelab AND program.IdPelajar= pelajar.IdPelajar AND program.IdPelajar ='" . $username . "'";
  ...
  <tbody>
    <tr>
	  ...
	  <td><?php echo $row["BilanganTerhad"]; ?></td>
      <td><?php echo $row["TarikhProgram"]; ?></td>
	  
		  
		  
		  
	  <td> <a class="btn btn-warning" href="edit.php?KodProgram_edit=<?php echo $row['KodProgram'];?>">Edit</a></td>
	  <td> <a class="btn btn-danger" href="delete.php?KodProgram_del=<?php echo $row['KodProgram'];?>">Delete</a></td>
	
		  <!-- Tambah form post-->
	  <td> <a class="btn btn-blue" href="attandance.php?KodProgram_record=<?php echo $row['KodProgram'];?>">Record</a></td>
