        ...
        <div class="my-3 my-md-5">
          <div class="container">
			  ...
			  <div class="container" ng-app="live_search_app" ng-controller="live_search_controller" ng-init="fetchData()">
				   <br />
				   <h3 align="center">Club Add, Update and Delete</h3>
				   <br />
					
				   <div class="alert alert-primary" role="alert">
					  Admin can add new club, delete club and update the data of the club.
					</div>
						
				   <div class="form-group">
					<div class="input-group">
					 <span class="btn btn-blue" disabled>SEARCH </span>
					 <input type="text" name="search_query" ng-model="search_query" ng-keyup="fetchData()" placeholder="Search by Club Name/Club Id" class="form-control" />
					</div>
				   </div>
				   
				   <a class="btn btn-blue" href="AdminAddClubForm.php">Add Club</a>
					<br>
				   ...
				   <table class="table table-striped">
					...
					<tbody>
					 <tr ng-repeat="data in searchData">
					  <td>{{ data.IdKelab }}</td>
					  <td>{{ data.NamaKelab }}</td>
					  <td> <a class="btn btn-warning" href="AdminEditClub.php?IdKelab_edit={{ data.IdKelab }}">Edit</a></td>	
				      <td> <a class="btn btn-danger" href="AdminDeleteClub.php?IdKelab_del={{ data.IdKelab }}">Delete</a></td>
					 </tr>
					</tbody>
