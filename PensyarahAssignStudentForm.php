				...
				<div class="row">
					<div class="col-sm-12">
						<div class="container" ng-app="live_search_app" ng-controller="live_search_controller" ng-init="fetchData()">
						   <br />
						   <h3 align="center">List of Student without Position</h3>
						   <br />
							
							<div class="alert alert-primary" role="alert">
							  This section will show all list of student without position. 
								</br>Admin can assign the position of student by searching the student name or student id.
						   ...
						   <div class="form-group">
							<div class="input-group">
							 ...
							 <input type="text" name="search_query" ng-model="search_query" ng-keyup="fetchData()" placeholder="Search Student ID / Name" class="form-control" />
							</div>
						   </div>
						   ...
						   <table class="table table-striped table-bordered">
							...
							<tbody>
							 <tr ng-repeat="data in searchData">
							  <td>{{ data.IdPelajar }}</td>
							  <td>{{ data.NamaPelajar }}</td>
							  <td><a class="btn btn-blue" href="PensyarahAssignStudentForm2.php?IdPelajar_data={{data.IdPelajar}}">ASSIGN</a></td>
							 </tr>
							</tbody>
	  ...
	  <script>
			...
			app.controller('live_search_controller', function($scope, $http){
			 $scope.fetchData = function(){
			  $http({
			   method:"POST",
			   url:"PensyarahFetchAssignStudent.php",
