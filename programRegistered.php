        ...
        <div class="my-3 my-md-5">
          <div class="container">
			...
			<div class="alert alert-primary" role="alert">
			  List of programs that have been registered.
			</div>
...
?>
  ...
  <tbody>
    <tr>
	  ...
	  <td> <a class="btn btn-danger" href="cancelJoin.php?KodProgram_cancelJoin=<?php echo $row['KodProgram'];?>"> Cancel Join </a></td>
