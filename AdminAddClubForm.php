    ...
    <div class="page">
      <div class="flex-fill">
		...
		<div class="col-md-12">
			...
			<form class="card" action="AdminAddClubPHP.php" method="post" enctype="multipart/form-data" >
			 <div class="card-body">
                  <h3 class="card-title">Add New Club</h3>
				 <fieldset class="form-fieldset">
                        <div class="form-group">
                          <label class="form-label">Club Id<span class="form-required">*</span></label>
                          <input type="text" class="form-control" name="idKelab" required=""/>
                        </div>
                        
                        <div class="form-group">
                          <label class="form-label">Club Name<span class="form-required">*</span></label>
						  <input type="text" class="form-control" name="namaKelab" required=""/>
