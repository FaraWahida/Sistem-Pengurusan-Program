          ...
          <div class="row">
            <div class="col col-login mx-auto">
              <div class="text-center mb-6">
                <img src="LOGOSPP2.png" class="h-8" alt="">
              </div>
              <form class="card" action="" method="post">
                ...
                <div class="card-body p-6">
                  ...
                  <div class="form-group">
					...
					<input type=text class="form-control" name="username" id="username" placeholder="Matric number or staff username">
                  </div>
                  <div class="form-group">
				...
				<div class="alert alert-icon alert-danger" role="alert" Display: none;>
 				 <i class="fe fe-alert-triangle mr-2" aria-hidden="true"></i> Please insert username and password.
				</div>
				<?php }?>	
