            ...
            <div class="container" ng-app="live_search_app" ng-controller="live_search_controller" ng-init="fetchData()">
				   ...
				   <br />
					<div class="alert alert-primary" role="alert">
					  List name of students that have been added.
					</div>
				   ...
				   <table class="table table-striped table-bordered">
					...
					<tbody>
					 <tr ng-repeat="data in searchData">
					  ...
					  <td>{{ data.NomborTelefon }}</td>
						 <td>{{ data.Jawatan }}</td>
						 <td>{{ data.NamaKelab }}</td>
					  <td><a class="btn btn-danger" href="AdminDeleteStudent.php?IdPelajar={{ data.IdPelajar }}">Delete</a></td>
	  ...
	  <script>
			...
			app.controller('live_search_controller', function($scope, $http){
			 $scope.fetchData = function(){
			  $http({
			   method:"POST",
			   url:"AdminFetchListOfStudent.php",
