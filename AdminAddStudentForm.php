    ...
    <div class="page">
      <div class="flex-fill">
		...
		<div class="col-md-12">
			...
			<form class="card" action="AdminAddStudentPHP.php" method="post" enctype="multipart/form-data" >
			 <div class="card-body">
                  <h3 class="card-title">Add New Student Form</h3>
				 <div class="alert alert-primary" role="alert">
				  Please fill the required fields to add new student.
				</div>
				 <fieldset class="form-fieldset">
                        <div class="form-group">
                          <label class="form-label">STUDENT ID<span class="form-required">*</span></label>
                          <input type="text" class="form-control" name="idPelajar" required=""/>
                        </div>
					   <div class="form-group">
                          <label class="form-label">STUDENT NAME<span class="form-required">*</span></label>
                          <input type="text" class="form-control" name="namaPelajar" required=""/>
                        </div>
					   <div class="form-group">
                          <label class="form-label">PHONE NUMBER<span class="form-required">*</span></label>
                          <input type="text" class="form-control" name="nomborTelefon" required=""/>
                        </div>
					   <div class="form-group">
                          <label class="form-label">STUDENT PASSWORD/ STUDENT IC NUMBER<span class="form-required">*</span></label>
                          <input type="text" class="form-control" name="passwordPelajar" required=""/>
                        </div>
						<input type="hidden" name="jawatan" value="PELAJAR"/>
					    <input type="hidden" name="idKelab" value="0"/>
