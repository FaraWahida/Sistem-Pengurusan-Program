<?php
	...
	$sqlProfile2 = "select s.IdStaf, s.NamaStaf, s.Jawatan, k.NamaKelab from staf s, kelab k where s.IdKelab=k.IdKelab AND s.IdStaf= '$username' ";

		$resultProfile2 = mysqli_query($conn, $sqlProfile2);
				while($rowProfile2 = mysqli_fetch_array($resultProfile2)){
						
				$StafId = $rowProfile2['IdStaf'];
				$StafNama = $rowProfile2['NamaStaf'];	
				$KelabNama = $rowProfile2['NamaKelab'];
				$StafJawatan = $rowProfile2['Jawatan'];
		}
							  ...
							  <div class="row">
								<div class="col-md-12">
								  <div class="form-group">
									...
									<input type="text" class="form-control" disabled="" placeholder="Name" value="<?php echo $StafNama ?>">
								  </div>
								</div>
								<div class="col-sm-6 col-md-6">
								  <div class="form-group">
									<label class="form-label">User ID</label>
									<input type="text" class="form-control" disabled="" placeholder="User ID" value="<?php echo $StafId ?>">
								  </div>
								</div>
								<div class="col-sm-6 col-md-6">
								  <div class="form-group">
									<label class="form-label">Position</label>
									<input type="text" class="form-control" disabled="" placeholder="Position" value="<?php echo $StafJawatan ?>">
								  </div>
								</div>
								<div class="col-sm-6 col-md-6">
								  <div class="form-group">
