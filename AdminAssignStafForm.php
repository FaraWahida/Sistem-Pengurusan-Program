						...
						<div class="container" ng-app="live_search_app" ng-controller="live_search_controller" ng-init="fetchData()">
						   ...
						   <br />
							...
							<div class="alert alert-primary" role="alert">
							  This section will show all list of lecturer. 
								</br>Admin can assign the club of lecturer by searching the lecturer name or lecturer id.
						   ...
						   <div class="form-group">
							<div class="input-group">
							 ...
							 <input type="text" name="search_query" ng-model="search_query" ng-keyup="fetchData()" placeholder="Search Lecturer ID / Name" class="form-control" />
							</div>
						   </div>
						   ...
						   <table class="table table-striped table-bordered">
							...
							<tbody>
							 <tr ng-repeat="data in searchData">
							  <td>{{ data.IdStaf }}</td>
							  <td>{{ data.NamaStaf }}</td>
							  <td><a class="btn btn-blue" href="AdminAssignStafForm2.php?IdStaf_data={{data.IdStaf}}">ASSIGN</a></td>
							 </tr>
							</tbody>
