    ...
    <div class="page">
      <div class="flex-fill">
		...
		<div class="col-md-12">
			...
			<form class="card" action="AdminAddStafPHP.php" method="post" enctype="multipart/form-data" >
			 <div class="card-body">
                  <h3 class="card-title">ADD NEW LECTURER</h3>
				 <div class="alert alert-primary" role="alert">
				  Please fill the required fields to add new lecturer.
				</div>
				 <fieldset class="form-fieldset">
                        <div class="form-group">
                          <label class="form-label">LECTURER ID<span class="form-required">*</span></label>
                          <input type="text" class="form-control" name="idStaf" required=""/>
                        </div>
					   <div class="form-group">
                          <label class="form-label">LECTURER NAME<span class="form-required">*</span></label>
                          <input type="text" class="form-control" name="namaStaf" required=""/>
                       </div>
					   <div class="form-group">
                        ...
                        <div class="form-group">
                          <label class="form-label">LECTURER PASSWORD / LECTURER IC NUMBER<span class="form-required">*</span></label>
                          <input type="text" class="form-control" name="passwordStaf" required=""/>
                        </div>
