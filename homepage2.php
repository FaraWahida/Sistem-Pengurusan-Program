			  ...
			  <div class="col-md-12">
				<div class="container">
					...
					<?php
						...
						$query = "select p.KodProgram, p.images, k.NamaKelab, p.ButiranProgram, p.TarikhProgram, p.NamaProgram from program p, kelab k where p.KodKelab=k.IdKelab order by TarikhUpload DESC ";
					...
					<div class="col-sm-8" >
						...
						<div class="card">
							...
							<p class="card-text">
							  ...
							  <h5>DATE OF PROGRAM: <?php echo $row1['TarikhProgram']; ?></h5>
