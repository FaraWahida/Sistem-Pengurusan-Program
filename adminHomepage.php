<?php
	...
	$sqlCountProgram = "SELECT COUNT(KodProgram) AS programCount FROM program ";
	$sqlCountPelajar = "SELECT COUNT(IdPelajar) AS studentCount FROM pelajar";
	$sqlCountStaf = "SELECT COUNT(*) AS stafCount FROM staf";
	$sqlCountKelab = "SELECT COUNT(*) AS kelabCount FROM kelab WHERE IdKelab!='0'";
					
		 $resultCountProgram = mysqli_query($conn, $sqlCountProgram);
				while($row= mysqli_fetch_array($resultCountProgram)){
						
				$programCount = $row['programCount'];
					
				}

				$resultCountPelajar = mysqli_query($conn, $sqlCountPelajar);
				while($row= mysqli_fetch_array($resultCountPelajar)){
						
				$pelajarCount = $row['studentCount'];
					
				}

			$resultCountStaf = mysqli_query($conn, $sqlCountStaf);
				while($row= mysqli_fetch_array($resultCountStaf)){
						
				$stafCount = $row['stafCount'];
					
				}

			$resultCountKelab = mysqli_query($conn, $sqlCountKelab);
				while($row= mysqli_fetch_array($resultCountKelab)){
						
				$kelabCount = $row['kelabCount'];
...
-->
					  ...
					  <div class="col-sm-6">
						<div class="card">
						  <div class="card-body text-center">
							<div class="h5">Number of Staff</div>
							<div class="display-4 font-weight-bold mb-4"><?php echo $stafCount ?></div>
						...
						<div class="card">
						  <div class="card-body text-center">
							<div class="h5">Number of Student</div>
							<div class="display-4 font-weight-bold mb-4"><?php echo $pelajarCount ?></div>
					...
					<div class="col-sm-6">
						<div class="card">
						  <div class="card-body text-center">
							<div class="h5">Number Of Program</div>
							<div class="display-4 font-weight-bold mb-4"><?php echo $programCount ?></div>
						...
						<div class="card">
						  <div class="card-body text-center">
							<div class="h5">Number Of Club</div>
							<div class="display-4 font-weight-bold mb-4"><?php echo $kelabCount ?></div>
