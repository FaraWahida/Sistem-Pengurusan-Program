			  ...
			  <div class="col-md-12">
				<div class="container">
					...
					<?php
						...
						$query = "select p.KodProgram, p.images, k.NamaKelab, p.ButiranProgram, p.TarikhProgram, p.NamaProgram from program p, kelab k where p.KodKelab=k.IdKelab and KodKelab='$KelabId' order by TarikhUpload DESC ";
					...
					<div class="col-sm-8" >
						...
						<div class="card">
							...
							<p class="card-text">
								...
								<h5>CLUB NAME: <?php echo $namaKelab ?></h5>
							  <h5>PROGRAM DATE: <?php echo $row1['TarikhProgram']; ?></h5>
								<h5>PROGRAM NAME: <?php echo $row1['NamaProgram'];?></h5>
					  ...
					  <h6 style="color: red;" > LIMIT OF PARTICIPANT: <?php echo $bilanganTerhad ?> </h6>
					  </div>
					</div> <!--tutop card-->
