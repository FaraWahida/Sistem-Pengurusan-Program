    ...
    <div class="page">
      <div class="flex-fill">
		...
		<div class="col-md-12">
			...
			<form class="card" action="uploadProgramPhp2.php" method="post" enctype="multipart/form-data" runat="server" >
			 <div class="card-body">
                  <h3 class="card-title">Upload Program Form</h3>
				 <div class="alert alert-primary" role="alert">
				  Please fill all the required fields for upload your program detail. 
				</div>
				 <fieldset class="form-fieldset">
                        <div class="form-group">
                          <label class="form-label">PROGRAM NAME<span class="form-required">*</span></label>
                          <input type="text" class="form-control" name="namaProgram" required=""/>
                        </div>
                        
                        <div class="form-group">
                          <label class="form-label">PROGRAM DETAIL<span class="form-required">*</span></label>
						  <textarea class="form-control" name="butiranProgram" rows="5" required=""></textarea>
					    ...
					    <div class="form-group">
                          ...
                          <input type="date" class="form-control" name="tarikhProgram" required=""/>
                        </div>
					    <div class="form-group">
                          <label class="form-label">LIMIT OF PARTICIPANT<span class="form-required">*</span></label>
                          <input type="text" class="form-control" name="limitOfParticipant" required=""/>
                        </div>
                      </fieldset>
				  </div>
