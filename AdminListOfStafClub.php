        ...
        <div class="my-3 my-md-5">
          <div class="container">
            <div class="page-header" align="center">
              <h3>List of Lecturer with Club</h3>
            </div>
			...
			<?php
				...
				$sql="SELECT s.IdStaf, s.NamaStaf, k.NamaKelab FROM staf s, kelab k WHERE s.IdKelab=k.IdKelab AND s.Jawatan='PENSYARAH' AND s.IdKelab != '0' ORDER BY k.NamaKelab ASC";
			...
			?>
			  ...
			  <tbody>
				<tr>
				  ...
				  <td><a class="btn btn-danger" href="AdminCancelClub.php?IdPelajar=<?php echo $row['IdPelajar'];?>">Cancel Jawatan</a></td>
				</tr> 
			  </tbody>
